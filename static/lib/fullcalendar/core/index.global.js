...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    function jDateToUtcArray(date) {
        let jd = jalaali.toJalaali(date.getUTCFullYear(), date.getUTCMonth(), date.getUTCDate() )
        return [
            jd.jy,
            jd.jm,
            jd.jd,
...
//            console.log('buildPrev', currentDate)
...
//             console.log('buildNext', currentDate)
             let { dateEnv } = this.props;
...
//            console.log('NNNNNNNN buildRangeFromDuration 11111 NNNNNNNN')
            ...
            let gDateStart;
            let gDateEnd;
//            let jDate = jalaali.toJalaali(dateEnv.getYear(date), dateEnv.getMonth(date), dateEnv.getDay(date))


//            console.log(dateEnv.getYear(date), dateEnv.getMonth(date), dateEnv.getDay(date))
...
//            console.log(dateEnv.getYear(date), dateEnv.getMonth(date), dateEnv.getDay(date) )
//            console.log( jDate.jy, jDate.jm , jDate.jd )
...
//                        end = dateEnv.startOf(gDateEnd, 'day');
    ...
    //                    gDateEnd = jalaali.toGregorian(jDate.jy, jDate.jm, jalaali.jalaaliMonthLength(jDate.jy, jDate.jm) + 1)
                        gDateEnd = jalaali.toGregorian(jDate.jy + 1, 1, 1)
    //                    console.log(jDate, gDateStart, gDateEnd)
                        const startDate = new Date(gDateStart.gy, gDateStart.gm, gDateStart.gd,0,0,0)
...
//            console.log('skipHiddenDays 1\n', date, inc, isExclusive)
            while (this.isHiddenDayHash[(date.getUTCDay() + (isExclusive ? inc : 0) + 7) % 7]) {
                date = addDays(date, inc);
            }
//            console.log('skipHiddenDays 2\n', date)
            return date;
        }
    }
    ...
    */
    ...
    class JalaaliCalendarSystem {
        getMarkerYear(d) {
            return d.getUTCFullYear();
        }
        getMarkerMonth(d) {
//            console.log('d.getUTCMonth():',d, d.getUTCMonth())
            return d.getUTCMonth();
        }
        getMarkerDay(d) {
            return d.getUTCDate();
...
//            console.log('markerToArray\n @@@@@@@@@@@@@@@@@@@@@@@\n', marker);
    ...
    registerCalendarSystem('jalaali', JalaaliCalendarSystem);
    ...
    */
    ...
    class SimpleScrollGrid extends BaseComponent {
        ...
        renderSection(sectionConfig, microColGroupNode, isHeader) {
            ...
            return (y("tr", { key: sectionConfig.key, role: "presentation 3", className: getSectionClassNames(sectionConfig, this.props.liquid).join(' ') }, this.renderChunkTd(sectionConfig, microColGroupNode, sectionConfig.chunk, isHeader)));
        }
        renderChunkTd(sectionConfig, microColGroupNode, chunkConfig, isHeader) {
//            console.log('renderChunkTd',sectionConfig, microColGroupNode, chunkConfig, isHeader)
...
//        console.log('buildDateEnv$1', timeZone)
        let calendarSystem = locale.codeArg == 'fa-IR' ? 'jalaali' : 'gregory';
    ...
    */
    ...
    function buildDateEnv(settings) {
        ...
        return new DateEnv(Object.assign(Object.assign({ timeZone: BASE_OPTION_DEFAULTS.timeZone, calendarSystem: locale.codeArg == 'fa-IR' ? 'jalaali' : 'gregory' }, settings), { locale }));
    }
